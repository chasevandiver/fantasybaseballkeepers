...
//     After being kept in 2026 → service_left_2027 = 1 (last year next year)
//   • service_left=1 + ft_eligible → can franchise tag for one more year
//     After being kept in 2026 via FT → service_left_2027 = 0 (DONE)
//   • FT max = 5 total seasons of ownership
//   • Not selected (not kept) → player re-enters 2026 draft at their current round
// ============================================================
